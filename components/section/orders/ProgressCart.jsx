                        ...
                        {step.status === 'complete' ? (
                            <>
                                {stepIdx !== steps.length - 1 ? (
                                    <div className="-ml-px absolute mt-0.5 top-4 left-16 w-full h-0.5 bg-green-500" aria-hidden="true" />
                                ) : null}
                            ...
                            <>
                                ...
                                <a href={step.href} className="relative flex items-start group" aria-current="step">
                                    <span className="h-9 flex items-center font-bold text-lg" aria-hidden="true">
